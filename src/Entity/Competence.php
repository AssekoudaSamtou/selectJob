...
class Competence
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\CompetenceOffre", mappedBy="competence", orphanRemoval=true)
     */
    ...
    public function addCompetenceOffre(CompetenceOffre $competenceOffre): self
    {
        if (!$this->competenceOffres->contains($competenceOffre)) {
            ...
            $competenceOffre->setCompetence($this);
        }
    ...
    public function removeCompetenceOffre(CompetenceOffre $competenceOffre): self
    {
        if ($this->competenceOffres->contains($competenceOffre)) {
            ...
            if ($competenceOffre->getCompetence() === $this) {
                $competenceOffre->setCompetence(null);
            }
        }
